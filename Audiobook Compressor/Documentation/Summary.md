...
The project is at version 1.2.F (Experimental). The core UI is complete, user settings persists across sessions, all logic is wired up, the UI has been polished and a test suite has been created.
